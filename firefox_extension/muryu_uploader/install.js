var XpiInstaller =
{
extFullName: 'Muryu Uploader', // The name displayed to the user (don't include the version)
extShortName: 'muryu', // The leafname of the JAR file (without the .jar part)
extVersion: '1.5',
extAuthor: 'Ilmari Heikkinen',
extLocaleNames: [],
extSkinNames: null,
