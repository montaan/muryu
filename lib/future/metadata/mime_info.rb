...
require "future/metadata/mime_info_magic"
...
public
	...
	def type_for_name(filename)
		...
		[basename, basename.downcase].each do |f|
			...
			@globs_ext.each { |k, v| return v if File.fnmatch(k, f) }
		end
...
module Mimetype
	...
	def extname
		(MimeInfo.instance.globs_ext.invert[@mimetype] || "")[1..-1]
	end
